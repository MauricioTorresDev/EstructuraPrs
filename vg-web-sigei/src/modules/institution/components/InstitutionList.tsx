 ...
 * Muestra la lista de instituciones con paginación y acciones
 */

import { useNavigate } from "react-router-dom";
import { Eye, Edit3, Trash2, RotateCcw, MapPin, Phone } from "lucide-react";
                                   ...
                                   >
                                        ...
                                        <td className="px-6 py-4">
                                             ...
                                             institution.contactMethods
                                                  .length > 0 ? (
                                                  <div className="flex items-start">
                                                       <Phone className="h-4 w-4 text-gray-400 mr-1 mt-0.5 flex-shrink-0" />
                                                       <div className="text-sm text-gray-600">
                                                            <div>
                                                                 {
                                                                      institution
