 ...
 * Página principal del módulo de Instituciones - Lista todos los registros
 */
     ...
     const handleDelete = async (id: string) => {
          try {
               ...
               setInstitutions((prev) =>
                    prev.map((inst) =>
                         inst.id === id
                              ? { ...inst, status: "INACTIVE" as InstitutionStatus }
                              : inst
                    )
               );
     ...
     const handleRestore = async (id: string) => {
          try {
               ...
               setInstitutions((prev) =>
                    prev.map((inst) =>
                         inst.id === id
                              ? { ...inst, status: "ACTIVE" as InstitutionStatus }
                              : inst
                    )
               );
               ...
               <div className="mb-6 bg-white p-4 rounded-lg shadow">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                         ...
                         <div>
                              ...
                              <select
                                   value={filters.institutionLevel || ""}
                                   onChange={(e) =>
                                        handleFilterChange({
                                             institutionLevel:
                                                  e.target.value ||
